<div class="accordion my-3" id="combine-1">
    <div class="card">
        <div class="card-header bg-slate-600" type="button" id="heading-1" data-toggle="collapse"
        ...
        <div id="collapse-1" class="collapse hidden" aria-labelledby="heading-1" data-parent="#combine-1">
            <div class="card-body">
                <div class="mt-3">
                    <p>
                        ...
                        <thead>
                            <tr>
                                <th class="bg-slate-100 text-gray-800" colspan="3">
                                    <p class="text-center my-0 py-0 h5 tracking-widest font-weight-bold"> COMBINATION 1 RANK </p>
                                </th>
                            </tr>
                            <tr>
                        ...
                        <thead>
                            <tr>
                                <th class="bg-slate-100 text-gray-800" colspan="6">
                                    <p class="text-center my-0 py-0 h5 tracking-widest font-weight-bold"> COMBINATION 1 RULES </p>
                                </th>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($combineFirst as $rules1)
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            If buy &nbsp; <i>{{ $prodname }}</i> &nbsp; Then buy &nbsp; <i> {{ $prodname }} </i>
                                        </div>
                                    </td>
                                    <td>
